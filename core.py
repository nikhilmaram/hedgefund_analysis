...
def _core_subgraph(G, degrees, k_filter, k=None, core=None):
...
def k_core(G, degrees, k=None, core_number=None):
    ...
    def k_filter(v, k, c):
        return c[v] >= k
    return _core_subgraph(G, degrees, k_filter, k, core_number)



def k_shell(G, degrees, k=None, core_number=None):
...
def k_crust(G, degrees, k=None, core_number=None):
...
def k_corona(G, degrees, k, core_number=None):
    ...
    return _core_subgraph(G, degrees, func, k, core_number)